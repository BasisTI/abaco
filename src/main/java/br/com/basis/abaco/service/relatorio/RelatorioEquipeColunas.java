...
public class RelatorioEquipeColunas extends PropriedadesRelatorio {
    ...
    public RelatorioEquipeColunas() {
        ...
        super.getColunas().add(new ColunasPropriedadeRelatorio("id", "Código da Equipe", Long.class, 10, DynamicExportsConstants.MASCARA_NULL, DynamicExportsConstants.ALINHAR_ESQUERDA));
